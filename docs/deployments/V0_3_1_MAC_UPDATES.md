...
- Build source: clean pushed `d1342dac435ed8858eb540a8f3e8ab1008ffba18`; normal universal app v0.3.1/build 6. Source and feed are under PR #14; stable promotion is pending final canonical-feed validation.
...
- No-update UI was verified against the earlier signed feed. Current app now supports Chinese UI through bundled locale declarations. Final current-version and network-error checks remain part of the closure gate.
...
- Temporary SUFeedURL override currently targets the immutable candidate feed; remove it after canonical main/CDN verification. Do not leave an acceptance override as production configuration.
