...
export const config = (overrides: Partial<RelayConfig> = {}): RelayConfig => ({ receiverId: 'phone', ntfyBaseUrl: 'https://ntfy.sh', topic: 'abcdefghijklmnopqrstuv', hapiOrigin: 'https://hapi.example', revision: 1, policy: policy(), ...overrides })
